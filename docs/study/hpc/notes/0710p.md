...
![一条 SIMD 指令在多个 lane 上完成相同运算](assets/0710/vector-simd.png)
...
![向量宽度并非越长越好：处理 512 位需要更宽的运算单元，代价是面积、成本与发热。](assets/0710/avx512-width-limit.jpg)
...
![SVE 用谓词处理尾部和条件执行，循环步长由硬件的实际向量长度决定。](assets/0710/sve-predicate.png)
